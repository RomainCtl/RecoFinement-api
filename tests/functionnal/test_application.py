...
class TestApplication:
    ...
    def test_application_validate_additional_content(self, test_client, headers_admin):
        ...
        response = test_client.put("/api/application/additional/"+str(app.app_id), headers=headers_admin)
    ...
    def test_application_decline_additional_content(self, test_client, headers_admin):
        ...
        response = test_client.delete("/api/application/additional/"+str(app.app_id), headers=headers_admin)
